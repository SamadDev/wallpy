...
class FavoriteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
          future: Provider.of<SLocalStorage>(context, listen: false).fetchLoveList(),
              ...
              : Consumer<SLocalStorage>(
                  builder: (ctx, love, _) => love.courseList.isEmpty
                      ...
                      : new StaggeredGridView.countBuilder(
                          ...
                          staggeredTileBuilder: (i) => StaggeredTile.count(2, i.isEven ? 3.5 : 2.8),
                          mainAxisSpacing: 0.0,
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (ctx) => DetailFavoriteWidget(image: love.courseList[i])));
                                },
                                child: ClipRRect(
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  decoration:
                                      BoxDecoration(color: AppTheme.black4, borderRadius: BorderRadius.circular(60)),
                                  child: GestureDetector(
                                      onTap: () {
                                        if (love.courseList.contains(love.courseList[i])) {
                                          love.removeCourse(url: love.courseList[i]);
                                        } else {
                                          love.addToLoveList(photo: love.courseList[i]);
                                        }
                                      },
                                      child: love.courseList.isEmpty
                                          ...
                                          : love.courseList.contains(love.courseList[i])
                                              ? Icon(
                                                  Icons.favorite,
